...
import com.fnaf.Client.Container.ContainerLootBox;
...
{
    public GUILootBox(Container p_i1072_1_) {
		super(p_i1072_1_);
    ...
    public GUILootBox(IInventory p_i1083_1_, IInventory p_i1083_2_)
    {
        super(new ContainerLootBox(p_i1083_1_, p_i1083_2_));
