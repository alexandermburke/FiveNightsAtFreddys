...
public class GUICamera extends GuiScreen {
	...
	public GUICamera(Tablet Item, NBTTagCompound itemNBTTag){
		super();
		this.cameraMonitor = Item;
		this.nbtTag = itemNBTTag;
	}
	
	public GUICamera(Tablet item, NBTTagCompound itemNBTTag, int page){
...
//		}
	...
	protected void actionPerformed(GuiButton guibutton){		
		if(guibutton.id == ((page * 5) - 4) && page > 1){
			this.mc.displayGuiScreen(new GUICamera(cameraMonitor, nbtTag, page -= 1));
