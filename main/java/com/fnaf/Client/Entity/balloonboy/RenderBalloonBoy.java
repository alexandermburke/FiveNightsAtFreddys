package com.fnaf.Client.Entity.balloonboy;
...
public class RenderBalloonBoy extends RenderLiving{
	...
	private static final ResourceLocation mobTextures = new ResourceLocation(com.fnaf.Common.main.Strings.MODID + ":textures/models/bb.png");
