package com.fnaf.Client.Entity.puppet;
...
public class RenderPuppetMob extends RenderLiving{
	...
	private static final ResourceLocation mobTextures = new ResourceLocation(com.fnaf.Common.main.Strings.MODID + ":textures/models/puppet.png");
