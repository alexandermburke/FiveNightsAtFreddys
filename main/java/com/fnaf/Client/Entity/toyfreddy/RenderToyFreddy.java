package com.fnaf.Client.Entity.toyfreddy;
...
public class RenderToyFreddy extends RenderLiving{
	...
	private static final ResourceLocation mobTextures = new ResourceLocation(com.fnaf.Common.main.Strings.MODID + ":textures/models/toyfreddy.png");
