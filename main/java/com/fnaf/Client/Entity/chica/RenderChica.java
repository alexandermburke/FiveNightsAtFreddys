package com.fnaf.Client.Entity.chica;
...
public class RenderChica extends RenderLiving{
	...
	private static final ResourceLocation mobTextures = new ResourceLocation(com.fnaf.Common.main.Strings.MODID + ":textures/models/chica.png");
