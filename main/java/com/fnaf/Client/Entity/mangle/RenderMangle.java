package com.fnaf.Client.Entity.mangle;
...
public class RenderMangle extends RenderLiving{
	...
	private static final ResourceLocation mobTextures = new ResourceLocation(com.fnaf.Common.main.Strings.MODID + ":textures/models/mangle.png");
