package com.fnaf.Client.Entity.toychica;
...
public class RenderToyChica extends RenderLiving{
	...
	private static final ResourceLocation mobTextures = new ResourceLocation(com.fnaf.Common.main.Strings.MODID + ":textures/models/toychica.png");
