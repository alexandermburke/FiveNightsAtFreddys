...
public class ItemPartyHat extends ItemArmor
{
	
	public ItemPartyHat(int armourType)
	{
		super(ArmorMaterial.CLOTH, 4, armourType); //TODO custom material
	}
    ...
    {
    	info.add("You can now wear Party Hats! (Put in helmet space.)");
    }
}
