...
public class EntityNightmareBonnieMob extends EntityMob{
	String newName = "Nightmare Bonnie";
	Minecraft mc = Minecraft.getMinecraft();
	EntityPlayer p = mc.thePlayer;
	
	
	public EntityNightmareBonnieMob(World par1World) {
		super(par1World);
	    this.setSize(0.6F, 3.4F);
