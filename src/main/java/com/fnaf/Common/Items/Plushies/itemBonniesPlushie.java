package com.fnaf.Common.Items.Plushies;
...
public class itemBonniesPlushie extends Item{
	
	
	public itemBonniesPlushie() {
		
		
	}
	
	
	public static void hasEffect() {
	  ...
	  @SideOnly(Side.CLIENT)
	    ...
	    {
	    	info.add("Right Click on the ground!");
	    }
		...
		else
		{
			...
			else
			{
				if (movingobjectposition.typeOfHit == MovingObjectPosition.MovingObjectType.BLOCK)
				{
					...
					EntityBonniePlushie robot = new EntityBonniePlushie(world);
