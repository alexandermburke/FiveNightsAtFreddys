...
public class GuiMainMenuFNAF extends GuiOverride implements GuiYesNoCallback
{
    ...
    private static final ResourceLocation splashTexts = new ResourceLocation(Reference.MODID + ":" + "texts/splashes.txt");
    private static final ResourceLocation minecraftTitleTextures = new ResourceLocation(Reference.MODID + ":" + "textures/gui/title/minecraft.png");
    /** An array of all the paths to the panorama pictures. */
    private static final ResourceLocation[] titlePanoramaPaths = new ResourceLocation[] {new ResourceLocation(Reference.MODID + ":" + "textures/gui/title/background/back.png")};
